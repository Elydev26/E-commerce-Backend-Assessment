...
export class Sh1738157286653 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."product_variationtype_enum" AS ENUM('NONE', 'OnlySize', 'OnlyColor', 'SizeAndColor')`);
        await queryRunner.query(`CREATE TABLE "product" ("id" SERIAL NOT NULL, "code" character varying NOT NULL, "title" character varying NOT NULL, "variationType" "public"."product_variationtype_enum" NOT NULL DEFAULT 'NONE', "description" text, "about" text array NOT NULL DEFAULT '{}', "details" jsonb, "isActive" boolean NOT NULL DEFAULT false, "merchantId" integer NOT NULL, "categoryId" integer, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_99c39b067cfa73c783f0fc49a61" UNIQUE ("code"), CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."product_variationtype_enum"`);
